 ...
 * @author beijunhua
 */
@ApiModel(value = "工伤上报表B")
public class GsbxSbbHzBResp extends PageQuery {
	@ApiModelProperty(value="工伤上报表B明细")
	private List<GsbxBResp> gsbxsbbbresps;
    ...
    public List<GsbxBResp> getGsbxsbbbresps() {
        return gsbxsbbbresps;
    }

    public void setGsbxsbbbresps(List<GsbxBResp> gsbxsbbbresps) {
        this.gsbxsbbbresps = gsbxsbbbresps;
    }
