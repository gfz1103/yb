 ...
 * @author beijunhua
 */
@ApiModel(value = "城镇特殊住院上报表B")
public class CztszySbbHzBResp extends PageQuery {
	@ApiModelProperty(value="城镇特殊住院上报表B明细")
	private List<CztszyBResp> cztszysbbresps;
    ...
    public List<CztszyBResp> getCztszysbbresps() {
        return cztszysbbresps;
    }

    public void setCztszysbbresps(List<CztszyBResp> cztszysbbresps) {
