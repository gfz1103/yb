 ...
 * @author beijunhua
 */
@ApiModel(value = "民政帮困上报表B汇总")
public class MzbkSbbHzBResp extends PageQuery {
	@ApiModelProperty(value="民政帮困上报表B明细")
	private List<MzbkBResp> mzbksbbbresps;
    ...
    public List<MzbkBResp> getMzbksbbbresps() {
        return mzbksbbbresps;
    }

    public void setMzbksbbbresps(List<MzbkBResp> mzbksbbbresps) {
        this.mzbksbbbresps = mzbksbbbresps;
    }
