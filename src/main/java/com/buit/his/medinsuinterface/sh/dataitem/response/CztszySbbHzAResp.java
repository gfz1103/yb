 ...
 * @author beijunhua
 */
@ApiModel(value = "城镇特殊住院上报表A汇总")
public class CztszySbbHzAResp extends PageQuery {
	@ApiModelProperty(value="城镇特殊住院A上报表明细")
	private List<CztszyAResp> cztszysbbresps;
    ...
    public List<CztszyAResp> getCztszysbbresps() {
        return cztszysbbresps;
    }

    public void setCztszysbbresps(List<CztszyAResp> cztszysbbresps) {
        this.cztszysbbresps = cztszysbbresps;
    }
