 ...
 * @author beijunhua
 */
@ApiModel(value = "异地门诊上报表B汇总")
public class YdopSbbHzBResp extends PageQuery {
	@ApiModelProperty(value="异地门诊上报表B明细")
	private List<YdopBResp> ydopbsbbresps;
    ...
    public List<YdopBResp> getYdopbsbbresps() {
        return ydopbsbbresps;
    }

    public void setYdopbsbbresps(List<YdopBResp> ydopbsbbresps) {
        this.ydopbsbbresps = ydopbsbbresps;
    }
    ...
    public void setZF_ALL(String ZF_ALL) {
        this.ZF_ALL = ZF_ALL;
    }
