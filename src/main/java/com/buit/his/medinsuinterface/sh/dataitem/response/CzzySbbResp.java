 ...
 * @author beijunhua
 */
@ApiModel(value = "城镇住院上报表")
public class CzzySbbResp extends PageQuery {
	...
	@ApiModelProperty(value = "个人账户历年支付起付")
	private BigDecimal GRZFLD;
	@ApiModelProperty(value = "个人账户历年支付其余")
	private BigDecimal GRZFLQ;
	@ApiModelProperty(value = "附加支付")
	private BigDecimal FJBX;
	...
	public BigDecimal getGRZFLD() {
		return GRZFLD;
	}

	public void setGRZFLD(BigDecimal GRZFLD) {
		this.GRZFLD = GRZFLD;
	}

	public BigDecimal getGRZFLQ() {
		return GRZFLQ;
	}

	public void setGRZFLQ(BigDecimal GRZFLQ) {
		this.GRZFLQ = GRZFLQ;
	}

	public BigDecimal getFJBX() {
		return FJBX;
	}

	public void setFJBX(BigDecimal FJBX) {
		this.FJBX = FJBX;
	}
