...
/**
 * @Author sunjx
 * @Date 2020-11-11 19:49
 * @Description
 **/
@ApiModel("配送单明细响应 YY006")
public class PsdYY006RespStruct {
    ...
    @ApiModelProperty("药品剂型, 参照国家药监发布的药品的“剂型”")
    private String YPJX;
    ...
    @ApiModelProperty("配送单明细状态, 详见4.1.22配送单明细状态")
    private String PSDMXZT;
    ...
    public String getPSDMXZT() {
        return PSDMXZT;
    }

    public void setPSDMXZT(String PSDMXZT) {
        this.PSDMXZT = PSDMXZT;
    }
}
