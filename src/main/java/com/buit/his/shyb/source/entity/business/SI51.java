...
//    @JsonFormat(pattern="yyyyMMdd")
    ...
    public String toString() {
        return "SI51 [cardtype=" + cardtype + ", carddata=" + carddata
                + ", personspectag=" + personspectag + ", yllb=" + yllb
                + ", persontype=" + persontype + ", gsrdh=" + gsrdh
                + ", cyjsbz=" + cyjsbz + ", jsksrq=" + jsksrq + ", jsjsrq="
                + jsjsrq + ", zyts=" + zyts + ", zyh=" + zyh + ", deptid="
                + deptid + ", zdnos=" + zdnos + ", jzdyh=" + jzdyh
                + ", xsywlx=" + xsywlx + ", mxzdhs=" + mxzdhs + "]";
    }
